...
struct MoE_SHM {
  ...
  struct TinyDataWGMMA_TMA {
    ...
    static constexpr uint32_t BF16_IN_FULL_K_BLOCKS = (Dims::BS <= 16) ? K_BLOCKS_TOTAL : 1;
    static constexpr uint32_t BF16_IN_FULL_BS = (Dims::BS <= 16) ? Dims::BS : 1;
    static constexpr uint32_t BF16_IN_FULL_K = (Dims::BS <= 16) ? CoreDims::K_STEP_WGMMA : 1;
    static constexpr uint32_t FP8_ACT_FULL_K_BLOCKS = (Dims::BS <= 16) ? K_BLOCKS_TOTAL : 1;
    ...
    static constexpr uint32_t SLOT_TO_TOKEN_LEN = (Dims::BS == 16u) ? MAX_PAIRS : 0u;
